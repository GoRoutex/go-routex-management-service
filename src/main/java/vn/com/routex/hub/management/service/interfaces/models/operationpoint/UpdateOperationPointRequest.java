...
@NoArgsConstructor
@SuperBuilder
public class UpdateOperationPointRequest extends BaseRequest {

    @Valid
    @NotNull
    private UpdateOperationPointRequestData data;
    ...
    @NoArgsConstructor
    @SuperBuilder
    public static class UpdateOperationPointRequestData {
        @NotNull
        @NotBlank
        private String id;
        private String code;
