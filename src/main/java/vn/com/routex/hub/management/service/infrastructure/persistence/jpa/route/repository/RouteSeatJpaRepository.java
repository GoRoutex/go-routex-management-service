...
import vn.com.routex.hub.management.service.infrastructure.persistence.jpa.route.entity.RouteSeatJpaEntity;
...
public interface RouteSeatJpaRepository extends JpaRepository<RouteSeatJpaEntity, Integer> {
    ...
    List<RouteSeatJpaEntity> findAllByRouteIdAndSeatNoIn(String routeId, List<String> seatNos);
}
