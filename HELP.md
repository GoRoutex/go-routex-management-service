...
* The original package name 'com.ecom.hub.user.service.' is invalid and this project uses 'com.ecom.hub.user.service' instead.
...
* [Spring Data JDBC](https://docs.spring.io/spring-boot/3.5.9/reference/data/sql.html#data.sql.jdbc)
